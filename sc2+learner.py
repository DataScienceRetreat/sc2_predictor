...
train_data_dir = '/Users/holger/dev/projects/dsr/sc2_predictor/data/test/'
validation_data_dir = '/Users/holger/dev/projects/dsr/sc2_predictor/data/validation/'
img_path = '/Users/holger/dev/projects/dsr/sc2_predictor/data/img/'
...
print(model.predict(img_internet))

filename = "NN_2Conv_03112016"

model.save(filename + '.h5')
plot(model, to_file='.png')
